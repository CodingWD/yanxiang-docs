...
The Innuo 3 delta board's built-in Arduino Leonardo supports 1 I2C communication interface, with the corresponding pins as follows: D2=SDA, D3=SCL.
...
| Innuo 3 Delta Pin Header | ADS1115 Module Pin |
| ----------------------------- | ------------------ |
| 5V                            | VCC                |
| GND                           | GND                |
| D3                            | SCL                |
