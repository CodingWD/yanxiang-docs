...
### Hardware<br>
   ...
   Innuo Board with Windows 10 System<br>


## Tutorial

- Download and install the Arduino IDE. However, if you are using the Innuo official image, the Arduino IDE is already incorporated into the Windows system, and this step can be bypassed.
...
- Launch the Arduino IDE. Navigate through the following selections: Tools -> Board -> Arduino Leonardo (or Innuo Leonardo). Afterwards, choose the COM port that corresponds to this board.

![](../../assets/images/IO Playability/InnuoLeonardo.webp)
