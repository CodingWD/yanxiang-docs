...
Insert the wireless network card into the M.2 E key socket on Innuo Sigma, and install the antennas.
...
There are two Ethernet ports on the Innuo board. Plug the ethernet cable, then surf the internet!
