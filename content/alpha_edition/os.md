...
This document will go over the operating systems that are compatible with the Innuo Alpha. It will also cover acceptable boot media as well as instructions and resources for installing the operating system and other special considerations.

## Overview

The Innuo Alpha is, in fact, globally recognized as the **FIRST development device supporting 4 different operating systems.**
...
!!! tips
    Please feel free to contribute or request new content via the [Official Docs Repository](https://github.com/InnuoTeam/Docs)
...
* [Innuo Alpha Windows 10 Image](https://www.dropbox.com/sh/d2d4xoe2nk7n0je/AACdzPN-bdwkwyHxe9KlSsiIa?dl=0).

### Installation Steps

* Download the Windows 10 disc image file for the Innuo Alpha.
...
* If you are using the Innuo to create the USB installation media, restart the Innuo. Otherwise, insert your USB drive into the Innuo and turn it on. 
...
!!! tips 
    This tutorial is for the Innuo Delta and Alpha. If you are using the 1st edition Innuo, please refer to the 1st edition documents.
...
* Restart the Innuo. Press 'Esc' continuously to enter BIOS. 
* Navigate to the "Boot" tab and change the "Boot Option Priorities" so that the USB drive is "Boot Option #1".
![](../../assets/images/USB_Boot_Order_Alpha.webp)
...
Wait for your LP to restart and then enter your password to log in. Your Ubuntu 16.04 LTS should be fully functional on your Innuo. Enjoy!

## Android (Phoenix OS)

The Innuo Alpha is also capable of using x86 versions of Android. One such version, is Phoenix OS. This version provides a desktop like Windows for an android system while also allowing access to the Google Play store.
...
Since the Innuo Alpha shares similar hardware as some Macbooks, it is possible to install macOS Mojave on the Innuo Alpha. In fact, some community members have already done this and posted installation tutorials. One such member, Novaspirit, created a very detailed tutorial video along with some installation files. 

!!! note
    MacOS is not an officially supported operating system. Some functionality may not work, or may require additional hardware to work. For example, the provided Innuo Wi-Fi card is not supported. A USB or M.2 E-key Wi-Fi card is required to receive Wi-Fi on macOS.**
...
[![Hackintosh Innuo Alpha](http://img.youtube.com/vi/nrJpwPxoZZ8/0.jpg)](http://www.youtube.com/watch?v=nrJpwPxoZZ8 "Guide: Innuo Alpha Hackintosh Intel M3-7Y30")

[Community discussions regarding this topic!](https://www.Innuo.com/topic-f11t16979p25805.html?hilit=hackintosh#p25805)
