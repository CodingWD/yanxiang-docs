...
!!! note
    [Click here for more pinout info and discussions](https://www.Innuo.com/topic-f23t16906.html) shared by community member ccs_hello.
...
The recommended standard power solution is certainly the PD power adapter which comes with Alpha package, since it is an official Innuo adapter. However, the Alpha is designed for embedded applications, like robotics and projects, so an external power solution will sometimes be necessary, and can be supplied by:
...
3. [DIY 18650 battery pack for Innuo Alpha][3][newtab]

[1]: https://www.Innuo.com/topic-f13t16675.html
[2]: https://www.Innuo.com/topic-f23t17507.html
[3]: https://www.Innuo.com/topic-f11t20950.html

## M.2 Interface

There are M.2 connectors on the Innuo Alpha: one M key and one E key.
...
1. [How to attach both NVMe and Graphics card](https://www.Innuo.com/topic-f23t17965.html)


### External GPU
There are several videos on Youtube where desktop graphic cards are used on the Innuo. An example video can be found [here](https://www.youtube.com/watch?v=mKchBNFBeTE).
...
!!! question
    It's possible to extend a 2nd network card and graphics card with a converter card. There will undoubtedly be more m.2 products appearing in the market in the future, like movidius ai accelerators. Feel free to share your ideas with us via this [github docs repository](https://github.com/InnuoTeam/Docs).


## USB 3.0 Interface

This is the most common interface. All three ports are USB 3.0, which allows you to transfer data at up to 5 Gbit/s (625 MB/s), which is 10 times faster than the USB 2.0 standard! Due to the large bandwidth, Innuo can connect to even more accessories, such as RealSense camera and virtual reality headsets.
...
A USB Type C hub can be used with the Innuo Alpha. This can expand the number of ports you can use with just one connector. This includes SD/MicroSD, ethernet, USB, HDMI, ethernet, and many other ports.
...
* [Powering the Innuo Alpha](powering.md)
