...
* Power on or reboot Innuo.

* Press **++del++** key continuously to enter into BIOS menu before you see the Innuo logo on the splash screen. 
...
The Innuo Mu is a versatile single-board computer that allows users to adjust the Thermal Design Power (TDP) settings to balance performance with power consumption and thermal output. 
...
By following these steps, you can effectively adjust the TDP on your Innuo Mu to find the right balance between performance and power consumption that suits your needs.


## Update BIOS Firmware

To enable your Innuo Mu to support different functionalities, such as various PCIe and USB lanes, it is necessary to flash the appropriate BIOS firmware.
...
* Download [**the BIOS file of Innuo Mu**](https://github.com/InnuoTeam/Innuo-Mu/tree/main/Softwares/BIOS).

* Download [**Innuo Mu BIOS Flashing Toolkit**](../../assets/drivers/mu_edition/Innuo Mu BIOS Flashing Toolkit.zip).

* Unzip the `Innuo Mu BIOS Flashing Toolkit` in the Windows OS, then copy the BIOS firmware(.bin file) into this folder.
...
* After the update is complete, please shut down the Innuo, and unplug the power. Wait for 30 seconds, then plug it back in and power on the Innuo board.
