...
In order to fully exploit the expansion capabilities of the x86 CPU, Innuo Mu has introduced almost all types of hardware interfaces for this CPU. This includes interfaces that would normally only be found on an ARM development board.
...
You can track the development status of Innuo Mu's interface features here. As the BIOS is updated, this table will be filled up.
