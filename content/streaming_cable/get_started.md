...
* **Microsoft Remote Desktop (RDP):** Support for Server Computers with Windows 10 Pro or above OS (such as Innuo Alpha or Delta), you can use Microsoft's standard RDP protocol for quickly configuration, seamless copy and paste, and get a full virtual machine experience
...
### Difference Between Solutions Above
    ...
    Innuo 2G / 4G - first generation series
        NoMachine is recommended
        Or you need to install Windows Pro on it to enable RDP feature


!!! Example
    I have a Innuo running Windows and Macbook Pro is my main desktop development computer.
    Then RDP solution will be recommended.

    But if you installed MacOS on Innuo Alpha and you use MacBook Pro, then NoMachine will the only option for you!


### Configuration

If this is the first time for you to use Innuo Streaming Cable, the **complete process** for configuration includes:
...
**So What's OS running on the Server Computer (Innuo)?**
