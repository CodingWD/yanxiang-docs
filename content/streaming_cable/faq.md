...
If you have problem when building the connection between your Innuo and master device, please feel free to open your issue via [Innuo forum](https://www.Innuo.com/forum/).

And we will really appreciate if you can help to optimize the tutorials by **committing tutorials or updates** to [docs repo](https://github.com/InnuoTeam/Docs). Help users, who have the same interests or meet problems like you do.
