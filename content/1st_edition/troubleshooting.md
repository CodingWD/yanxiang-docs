...
If you have any problems when viewing our DOCS, feel free to contact us and discuss [through the forum](http://www.Innuo.com/topic-f16t1713.html). We, together with our community members, are always ready to help you!

## How do I know Innuo is on?

There is one LED under Innuo. When LP is on, you should see the PWR LED light up continuous and bright.

## How do I re-install Innuo Windows system?
...
**Device required**: 1 x USB flash Drive (at least 5GB for Innuo Standard and 8GB for Innuo Enhanced)

Please follow the steps below to re-install Windows 10 to its "out of the box" state.

1.Download your Innuo's official Windows 10 image

![z8350 mark](../../assets/images/LP V1/V1 OS/8350-sticker.webp)
...
## How to install Windows Enterprise on Innuo?

We announced the Innuo 4G/64GB version with Windows Key. If you need to know how to install a Windows Enterprise system on Innuo or want know how to activate Windows key on your board, **just check this simple [tutorial](https://www.Innuo.com/forum/topic/313371) contributed by community member**.

## What Boot Method Does Innuo Use?

1. Innuo BIOS uses UEFI boot
2. As we use different Windows images for two LP versions, the BIOS's bit depth should match the image. So Innuo 2G/32GB uses a 32bit UEFI boot and 4G/64GB uses a 64bit UEFI boot.

If you are trying to install a different OS such as Linux, we have had some luck using multiarch images. We are still experimenting with this. We recommend looking on the [forum](https://www.Innuo.com/forum/) for more information.

## Tested Power Accessories

Good power supply can ensure stable work of Innuo. If you can’t start it, experience automatic shutdown and other problems in the process of using Innuo, please check your adapter and USB cable so that whether they reach the specified requirements.
...
- **link: ** [DFRobot](http://www.dfrobot.com/index.php?route=product/product&product_id=933&search=Innuo&description=true#.V1UDL2OxhVo), [Amazon](http://www.amazon.com/Adapter-Nillkin%C2%AEUS-Standard-Charger-Samsung/dp/B015SL0Y3I/ref=sr_1_1?ie=UTF8&qid=1465189045&sr=8-1&keywords=NILLKIN+5V+2A+USB) **Model: ** APPLE ipad 10W usb power adapter
...
- **Model: ** Innuo Double Sided Micro USB Cable

  **Test Results: ** available

  **Wire Diameter: ** 0.9mm

- **link: ** [DFRobot](http://www.dfrobot.com/index.php?route=product/product&product_id=1430&search=Innuo&description=true#.V1UEk2OxhVo) **Model: ** REMAX RC-025T
...
Specific to embedded and robot applications scenarios, Innuo also provides two pairs of external power supply pin of 5v and Gnd, check pinout diagram to find the external power connector beside the MicroUSB connector.  
...
- *2G version.*  --Please check [here](https://www.Innuo.com/forum/topic/313259).
...
- *The Red LED light on all time.*   --Please check [here](https://www.Innuo.com/forum/topic/319697).

### Accessories :

- *Touchpanel  isn't working properly.*   --Please check [here](https://www.Innuo.com/forum/topic/313171).
- *No HDMI output.*  --Please check [here](https://www.Innuo.com/forum/topic/313168).

### Other :

- *Power the board via CN2 headers.*   --Please check [here](https://www.Innuo.com/forum/topic/312864).

- *Change resolution.*  --Please check [here](https://www.Innuo.com/forum/topic/313510).
