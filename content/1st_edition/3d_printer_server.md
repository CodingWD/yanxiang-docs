...
In this tutorial, we will discuss how to control and monitor a 3D printer remotely using OctoPrint and a Innuo SBC.
...
The second URL is used to Connect to your 3D printer remotely from another PC on the same local network as your Innuo. The address 192.168.2.104 is actually your Innuo's IP address. If the CMD window doesn't display the second URL, you can look for the IP address in your computer's Network and Sharing Center and attach the port number `:5000` at the end of the IP address you find.
...
You can now open OctoPrint on any other computer or phone (connected to the same local Network as your Innuo) and log in to the  monitor and control your printer remotely!
