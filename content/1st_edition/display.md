...
Innuo officially released a [7" touch display](https://www.dfrobot.com/product-1413.html) and [10" IPS high-resolution display](https://www.dfrobot.com/product-1657.html) for the Innuo 1st gen product line. 
We are also working with several partners to deliver customized displays for the commercial market, if you need it, kindly reach out to [**Innuo Business Team**](mailto:Innuo@outlook.com) for personalized consultation.
...
!!! warning
    Please connect this device to the Innuo BEFORE powering it on. Additionally, please make sure that the Golden Finger faces the right side. The contacts on the FPC (Flexible Printed Circuit) are very compact and in a specific order. Please be careful not to have any dislocation in the connection which may cause the Innuo to short circuit and lead the IPS display to have abnormalities like ghost images or flickering.
...
* Check the hardware pin map of the MIPI-DSI and I2C touch interface of the Innuo via the [official pinout diagram](hardware_introduction.md)

* To enable a display or touch panel, a driver development or bios development might be necessary in most cases. It is advised to have a development expert in your team working with you on this operation before making this sort of attempt. You can also connect with the Innuo Business Team via our [email](mailto:Innuo@outlook.com) to apply for a display development request from Innuo in order to provide support for the display you've chosen. 

* All HDMI displays and USB touch screen solutions are 100% compatible with the Innuo 1st gen, as long as vendors' products provide support for Windows 10.
