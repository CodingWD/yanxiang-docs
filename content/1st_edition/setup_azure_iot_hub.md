...
This document describes how to build and run the Azure IoT Hub application on your Innuo.
...
This tutorial is adapted from this [link](https://github.com/Azure/azure-iot-sdks) . The functions themselves have been adapted for the Innuo SBC. This sample uses Node.JS. [Click here](https://github.com/Azure/azure-iot-sdks) for more language options and additional tutorials.
...
- [Prepare your development environment](http://www.Innuo.com/docs/#Prepare_your_development_environment).
- [Set up your IoT Hub](http://www.Innuo.com/docs/#Set_up_IoT_Hub)
- [Check your device's provisional use and credentials](http://www.Innuo.com/docs/#manage_iot_hub)
...
![create-iot-hub1](../../assets/images/LP%20V1/V1_Azure/create-iot-hub1-1.webp)

3.In the **New IoT Hub** section, specify the desired configuration for the IoT Hub.

![create-iot-hub2](../../assets/images/LP%20V1/V1_Azure/create-iot-hub2.webp)
...
- The cross-platform, command-line [iothub-explorer](http://www.Innuo.com/docs/#iothub-explorer) tool
...
- Note: You must have an IoT Hub running in Azure before you can obtain a provisional license for your device. The document [Set up IoT Hub](http://www.Innuo.com/docs/#Set_up_IoT_Hub) describes how to set up an IoT Hub.
...
1. Get the connection string for your IoT Hub. See [Set Up IoT Hub](http://www.Innuo.com/docs/#Set_up_IoT_Hub) for more details.
