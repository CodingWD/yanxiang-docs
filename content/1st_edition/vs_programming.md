...
## Step 1: Set Up Your PC
 ...
 3.Download [Innuo.Firmata](https://github.com/InnuoTeam/Innuo-Development-Support/tree/master/InnuoFirmata)


   [Innuo.Firmata](https://github.com/InnuoTeam/Innuo-Development-Support/tree/master/InnuoFirmata) is an open-source Firmata library provided by Innuo, which is suitable for Windows apps developed in Visual Studio. This class allows you to control Arduino GPIO from Windows apps, with features including:
...
Create a project or use the [sample project here.](../../assets/images/LP%20V1/V1_Physical_Programming/blinkYourBoard.zip)
 ...
 2.[Download the Innuo.Firmata class library](https://github.com/InnuoTeam/Innuo-Development-Support/tree/master/InnuoFirmata)
 ...
 4.Add the following code to Program.cs.
   ...
   - Add the following two lines of code before the line of code "namespace blinkYourBoard."
     ...
     The first line of code controls delay commands and the second line is a Innuo.Firmata class library namespace
