...
This document will review the different ways you can display the screen from your Innuo. It will also go over what you will need and the installation steps.

!!! warning
    Make sure to ground yourself and get rid of the static electricity on your body before touching your Innuo SBC board. Failing to ground yourself may cause static electricity discharge into the board components, damaging your Innuo.

## Overview

### 4 Ways to Extend Your Display on the Innuo Delta
...
1. Connect an HDMI cable to the Innuo HDMI port.
...
!!! note
    In order to power on the Innuo Alpha/Delta with the USB Type C port while using a USB Type C adapter, the adapter must have current in the Power Delivery passing through.
...
1. Connect the USB Type C adapter to the Innuo Alpha/Delta USB Type C port.
...
* [Innuo Alpha/Delta eDP display](https://www.dfrobot.com/product-1853.html?search=edp)

### Installation Steps

!!! warning
    Make sure to connect the display before you turn on your Innuo. Also make sure that the cable is installed correctly before turning the power on. Failure to follow these instructions below may cause a short-circuit and damage the Innuo or display.

1. Make sure the Innuo is powered off and that the power supply cable is disconnected.
...
While the Innuo Alpha/Delta eDP display is officially supported by our company, here we have some other displays that our community members have gotten working.
...
* [Official eDP display for Innuo Alpha and Delta](https://www.dfrobot.com/product-1853.html?search=edp)

!!! warning
    The MIPI display designed for Innuo 1st genernation is not compatible with the eDP display connector design on the Alpha and Delta. This compatibility issue is caused by different CPU architectures and positionings of components.
...
* [Powering on the Innuo Alpha/Delta](powering.md)
