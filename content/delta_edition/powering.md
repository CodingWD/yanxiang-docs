...
This document describes the different ways you can power on your Innuo. It will cover the input specification, what you will need, and installation steps.
...
1. Official PD adapter that comes with the Innuo Delta(Recommended)
...
2. Connect the USB Type C connector to the Innuo Delta USB Type C port.
