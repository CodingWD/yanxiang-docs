...
In this chapter, we will show the steps to install Ubuntu 22.04 on Innuo 3 Delta.
...
* Insert your USB drive into Innuo, and turn on the Innuo(Note that if you created the USB installation media on the same Innuo, you'll need to restart the device before beginning the installation process).
...
![boot_option_select](../../assets/images/Innuo 3 Delta/boot_option_select.webp)
...
![GUN_GRUB](../../assets/images/Innuo 3 Delta/GUN_GRUB.webp) 

* Please double-click the **`Install Ubuntu`** icon. After double-clicking, the installation will begin.(as shown below)

![](../../assets/images/Innuo 3 Delta/Ubuntu_Start_Install.webp)

* Choose your default language and continue. 

![Ubuntu_keyboard_layout](../../assets/images/Innuo 3 Delta/Ubuntu_keyboard_layout.webp)

![Ubuntu_updates_software](../../assets/images/Innuo 3 Delta/Ubuntu_updates_software.webp)
...
![Ubuntu_installation_type](../../assets/images/Innuo 3 Delta/Ubuntu_installation_type.webp)

![Ubuntu_installation_type_confirm](../../assets/images/Innuo 3 Delta/Ubuntu_installation_type_confirm.webp)

* Confirm the select drive and and that you wish to proceed with writing the previous changes to the disk.

![Ubuntu_drive](../../assets/images/Innuo 3 Delta/Ubuntu_drive.webp)

![Ubuntu_change_to_disk](../../assets/images/Innuo 3 Delta/Ubuntu_change_to_disk.webp)

* Select your time zone and click **`continue`** to proceed.

![Ubuntu_time_zone](../../assets/images/Innuo 3 Delta/Ubuntu_time_zone.webp)

* Fill out all of the required input fields.

![Ubuntu_user_name](../../assets/images/Innuo 3 Delta/Ubuntu_user_name.webp)

* Please be patient and wait for the installation to complete. Then, you will be asked to restart Innuo to complete the installation.

![Ubuntu_install_process](../../assets/images/Innuo 3 Delta/Ubuntu_install_process.webp)

Wait for your Innuo to restart and boot up Ubuntu, then enter your password to log in. Enjoy it!

!!! Attention
    In older BIOS versions(LP-BS-7-S70JR120-CN51G-D and earlier), if you choose to <span style="color: rgba(225, 103, 13);">**install Ubuntu alongside Windows Boot Manager**</span>, Innuo may boot into Windows instead of Ubuntu after restart , or Ubuntu doesn't show in the boot order priorities, please take the following steps:

    * Select **`UEFI Hard Disk Drive BBS Priorities`**.
    * Change the device in 'Boot Option #1/2'
    
    ![](../../assets/images/Innuo 3 Delta/harddisk_order_3Delta.webp)
