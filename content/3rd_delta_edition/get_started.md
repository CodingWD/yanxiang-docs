...
This chapter will show how to start with your Innuo 3 Delta at the first time. It will demonstrate what you need and instructions to boot up Innuo 3 Delta.

## Booting the Innuo

### Preparations

Before booting your Innuo 3 Delta, you will need the following accessories:
...
!!! Warning "Electrostatic Warning"
    ...
    While we have implemented anti-static design, please take care to eliminate static electricity from your body before handling the Innuo. Failure to do so can lead to potential damage caused by static discharge.
...
- **Attach the Wi-Fi/BT antennas to the sockets.**
   ...
   ![Innuo 3 Delta antennas](../../assets/images/Innuo 3 Delta/AssembleAntennas_3Delta.webp)
...
- **Connect an HDMI display.**
    ...
    Please see the [**Display Connections**](touch_and_display.md) section for instructions on using different displays with your Innuo.

- **Connect the keyboard and mouse to Innuo.**

- **Connect the power adapter(Provided) to Innuo.**

    Please see the [**Powering Options**](powering.md) section for instructions on using different power adapters to power your Innuo.
