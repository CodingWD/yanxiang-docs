...
## 3 Ways to Extend Your Display on Innuo 3 Delta
...
!!! Note "4K HDR"
    The Innuo 3 Delta provides support for HDMI 2.0b, thus, if you intend to connect it to a display capable of 4K 60Hz or 4K HDR, it is advisable to employ an HDMI 2.0b cable.
...
!!! Note
    ...
    The USB Type C dock must support external PD power input and transfer data with the Innuo by USB Type C port.
...
- If your display device does not have a USB Type C port, you will need a **USB Type C Dock**. Please follow these steps:
    ...
    ```markdown
    a. Connect the USB Type C Dock to the USB Type C port of your Innuo.
...
![type_C_display](../../assets/images/Innuo 3 Delta/type C display_3 delta.webp) 
    ...
    a. Connect the USB Type C cable to the USB Type C port of your Innuo.
...
In most cases, any display devices which have a 30Pin eDP connector and is powered by 3.3V is compatible with Innuo 3 Delta and don't require additional drivers. The eDP connector of Innuo 3 Delta has 2 lanes.

### Preparations

* [eDP touch display for Innuo 3 Delta](https://www.dfrobot.com/product-1853.html)
...
- Ensure the Innuo is powered off and disconnected from power supply cable.
- Open the eDP latch on the bottom of Innuo.
- Align the eDP cable with the eDP cable connector on Innuo. Make sure the gold finger of the eDP cable faces away from the bottom of Innuo.
- Insert the eDP cable, then press down the latch to secure the eDP cable.

![edp](../../assets/images/Connect_eDP_Alpha.webp)

### Additional eDP Displays from Innuo Community

Although Innuo officially offers the [7 inch eDP touch display](https://www.dfrobot.com/product-1853.html), our community members have successfully made use of a variety of alternative displays.

* [17.3" Display](https://www.Innuo.com/topic-f23t17107.html?start=11)
* [14.0'' BOE Display](https://www.Innuo.com/forum/topic/322393)
* [Fixing Screen Flickering Issues on Innuo 3 Delta when connecting other eDP displays](https://www.Innuo.com/forum/topic/320736)
