...
| Q                          | A                                                            |
| -------------------------- | ------------------------------------------------------------ |
| Can not boot up            | 1. Check again that the power adapter is tightly connected, and the voltage is within the required range 12~15V.<br/>2. Try disconnecting the power adapter for a few seconds, then connect the power adapter. Turn on the  Innuo again. |
...
!!! question "**Q1:** Why the Innuo boot into the EFI shell upon powering on instead of the Windows or Linux OS?"
...
!!! question "**Q2:** I have set up the auto power-on feature in the BIOS of the Innuo 3 Delta, but it becomes ineffective once the RTC battery runs out. Is there any way to ensure that the auto power-on feature is natively supported by the hardware regardless of the RTC battery's status?"
    **:bulb: :** Yes, there is a workaround provided by our community members. You can use the onboard Arduino pins to maintain the auto power-on functionality without being affected by the RTC battery's condition. For detailed instructions, please visit our forum: [**Innuo Forum - Use the Onboard Arduino to enable Innuo 3 Delta to auto power on**](https://www.Innuo.com/forum/topic/335313).


If you have problem when using Innuo 3 Delta, please feel free to open your issue via [**Innuo Forum**](https://www.Innuo.com/forum/) or join our [**Discord**](https://discord.com/invite/UHgtJbf978).
